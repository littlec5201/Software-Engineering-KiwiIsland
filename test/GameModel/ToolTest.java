...
/**
    ...
    @Test
    public void testIsSuperTrap(){
        Tool superTrap = new Tool(new Position(island, 3, 2), "SuperTrap", "A predator trap", 3.0, 5.0);
        assertTrue("Should  be super trap", superTrap.isSuperTrap());
