...
public class IslandTest extends junit.framework.TestCase
{
    ...
    public void testGetTerrain(){
        testTerrainSquare = new GridSquare(Terrain.FOREST);
    ...
    public void testSetTerrain(){
        testIsland.setTerrain(onIsland, Terrain.WETLAND);
        assertEquals(testIsland.getTerrain(onIsland), Terrain.WETLAND);
        
    }
    
    @Test
    public void testHasOccupant(){
        pie = new Food(onIsland, "pie", "A warm hearty pie", 3.0, 3.0, 3.0);
        testIsland.addOccupant(onIsland, pie);
        assertTrue(testIsland.hasOccupant(onIsland, pie));
        
    }
    
    @Test
    public void testGetOccupantName(){
       Food apple = new Food(onIsland, "Apple", "A green apple", 4.0, 1.0, 2.0);
        testIsland.addOccupant(onIsland, apple);
        assertEquals(testIsland.getOccupantName(onIsland), "Apple");
    }
    
    @Test
    public void testGetOccStringRep(){
        Predator lion = new Predator(onIsland, "Lion", "A furry lion");
        Position pos = new Position(testIsland, 2, 4);
        testIsland.addOccupant(pos, lion);
        assertEquals(testIsland.getOccupantStringRepresentation(pos), "P");
    ...
    public void testAddOccupant(){
        Predator lion = new Predator(onIsland, "Lion", "A furry lion");
        Position pos = new Position(testIsland, 2, 4);
        assertEquals(testIsland.addOccupant(pos, lion), true);
    }
